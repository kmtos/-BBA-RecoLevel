...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:file:/afs/cern.ch/user/k/ktos/BoostedDiTau/CMSSW_7_4_1_patch1/src/BoostedTauAnalysis/CleanJets/OUTPUT/CleanJets_edmOuput.root'),
...
process.out = cms.OutputModule("PoolOutputModule",
        fileName = cms.untracked.string("file:RECO_Step3_amumu_a5_TrigProd_NUM.root"),
